...
app.config['SQLALCHEMY_DATABASE_URI'] = SQLALCHEMY_DATABASE_URI = 'mysql://findme@localhost/findme'
app.config['SECRET_KEY'] = "findme"
ds = SQLAlchemy(app)
migrate = Migrate(app.ds)
...
def userRegister():
    if request.method == 'POST':
        ...
        # Check if email, usernam e, and phone already exist
